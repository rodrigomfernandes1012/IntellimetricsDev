...
ponto_blueprint = Blueprint('ponto', __name__)
...
#@ponto_blueprint.route('')

#Selecionar registros no EndPoint AcessoIntelBras
@ponto_blueprint.route("/AcessoIntelBras")
...
@ponto_blueprint.route('/AcessoIntelBras', methods=['POST'])
...
@ponto_blueprint.route('/notification', methods=['POST'])
def event_receiver():
...
@ponto_blueprint.route('/keepalive', methods=['GET'])
def keep_alive():
    return "OK"
