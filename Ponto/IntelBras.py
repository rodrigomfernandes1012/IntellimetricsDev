...
class IntelbrasQREnc(object):
    ...
    def encrypt(self, cardNrHexStr):
        ...
        cardNrHex = int(cardNrHexStr, 16).to_bytes(8, byteorder='big')
...
# CRIA ARQUIVO BASE64 DA IMAGEM PARA CADASTRAR
...
qrcodeStr = GerarCard(CardNo)
arquivo = cria_base64("qrcode.png")

#arquivobase64 = cria_base64(arquivo)
enviaimgwhats(arquivo)



api.add_user_v1(Nome, CardNo, qrcodeStr, CardType,  CardStatus, Senha, True)
api.add_card_v2(UserID, qrcodeStr, CardType, CardStatus)
